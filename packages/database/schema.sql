-- =============================================================================
-- GanaTrack - Estructura de Base de Datos
-- Consolidado de migraciones 0000, 0001, 0002
...
CREATE UNIQUE INDEX `uq_usuarios_roles` ON `usuarios_roles_asignacion` (`usuario_id`,`rol_id`);
...
CREATE UNIQUE INDEX `uq_potreros_predio_codigo` ON `potreros` (`predio_id`,`codigo`);
...
CREATE UNIQUE INDEX `uq_sectores_predio_codigo` ON `sectores` (`predio_id`,`codigo`);
...
CREATE UNIQUE INDEX `uq_parametros_predio_codigo` ON `config_parametros_predio` (`predio_id`,`codigo`);
...
CREATE INDEX `idx_animales_predio_activo` ON `animales` (`predio_id`,`activo`);
CREATE UNIQUE INDEX `uq_animales_predio_codigo` ON `animales` (`predio_id`,`codigo`);
...
CREATE UNIQUE INDEX `uq_productos_predio_codigo` ON `productos` (`predio_id`,`codigo`);
...
CREATE UNIQUE INDEX `uq_productos_imagenes` ON `productos_imagenes` (`producto_id`,`imagen_id`);
...
CREATE INDEX `idx_reportes_exportaciones_predio_activo` ON `reportes_exportaciones` (`predio_id`,`activo`);
CREATE INDEX `idx_reportes_exportaciones_usuario_activo` ON `reportes_exportaciones` (`usuario_id`,`activo`);
CREATE INDEX `idx_reportes_exportaciones_estado` ON `reportes_exportaciones` (`estado`);
...
CREATE INDEX `idx_notificaciones_predio_activo` ON `notificaciones` (`predio_id`,`activo`);
