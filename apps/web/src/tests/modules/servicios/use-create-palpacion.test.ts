// apps/web/src/tests/modules/servicios/use-create-palpacion.test.ts
/**
 * useCreatePalpacion hook tests.
 *
 * Tests:
 * - create function
 * - isPending state
...
// Import AFTER mock
const { useCreatePalpacion } = await import('@/modules/servicios/hooks/use-create-palpacion');
...
describe('useCreatePalpacion', () => {
  describe('create', () => {
    it('debería llamar al servicio createPalpacion', async () => {
    ...
    it('debería ejecutar la mutación correctamente', async () => {
      mockServiciosService.createPalpacion.mockResolvedValueOnce({ id: 1 });
    ...
    it('debería retornar error cuando el servicio falla', async () => {
      mockServiciosService.createPalpacion.mockRejectedValueOnce(new Error('API Error'));
    ...
    it('debería navegar a la lista de palmaciones después de éxito', async () => {
      mockServiciosService.createPalpacion.mockResolvedValueOnce({ id: 1 });
