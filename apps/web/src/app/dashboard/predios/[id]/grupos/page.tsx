// apps/web/src/app/dashboard/predios/[id]/grupos/page.tsx
/**
 * Grupos list page within Predio context — displays grupos for a specific Predio.
 */
...
export default function PredioGruposPage(): JSX.Element {
  ...
  const handleEdit = (grupo: { id: number }) => {
    router.push(`/dashboard/predios/${predioId}/grupos/${grupo.id}/edit`);
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href={`/dashboard/predios/${predioId}/grupos/nuevo`}>
          <Button>
      ...
      <div>
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Grupos</h1>
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
          Gestiona los grupos de este predio
        </p>
      </div>
