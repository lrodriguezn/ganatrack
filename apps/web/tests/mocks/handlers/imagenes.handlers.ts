// apps/web/tests/mocks/handlers/imagenes.handlers.ts
/**
...
export const imagenesHandlers = [
  ...
  http.get('*/api/v1/imagenes', ({ request }) => {
  ...
  http.get('*/api/v1/imagenes/:id', ({ params }) => {
  ...
  http.post('*/api/v1/imagenes/upload', async ({ request }) => {
  ...
  http.delete('*/api/v1/imagenes/:id', ({ params }) => {
    const id = Number(params.id);
