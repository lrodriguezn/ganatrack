...
export const maestrosHandlers = [
  ...
  http.get('*/api/v1/maestros/:tipo', ({ params }) => {
  ...
  http.post('*/api/v1/maestros', async ({ request }) => {
  ...
  http.put('*/api/v1/maestros/:id', async ({ params, request }) => {
  ...
  http.delete('*/api/v1/maestros/:id', ({ params }) => {
    const id = Number(params.id);
