...
import type { CrearVeterinarioUseCase } from '../../../application/use-cases/crear-veterinario.use-case.js'
import type { GetVeterinarioUseCase } from '../../../application/use-cases/get-veterinario.use-case.js'
import type { ListVeterinariosUseCase } from '../../../application/use-cases/list-veterinarios.use-case.js'
import type { UpdateVeterinarioUseCase } from '../../../application/use-cases/update-veterinario.use-case.js'
import type { DeleteVeterinarioUseCase } from '../../../application/use-cases/delete-veterinario.use-case.js'
import type { CrearPropietarioUseCase } from '../../../application/use-cases/crear-propietario.use-case.js'
import type { GetPropietarioUseCase } from '../../../application/use-cases/get-propietario.use-case.js'
import type { ListPropietariosUseCase } from '../../../application/use-cases/list-propietarios.use-case.js'
import type { UpdatePropietarioUseCase } from '../../../application/use-cases/update-propietario.use-case.js'
import type { DeletePropietarioUseCase } from '../../../application/use-cases/delete-propietario.use-case.js'
import type { CrearHierroUseCase } from '../../../application/use-cases/crear-hierro.use-case.js'
import type { GetHierroUseCase } from '../../../application/use-cases/get-hierro.use-case.js'
import type { ListHierrosUseCase } from '../../../application/use-cases/list-hierros.use-case.js'
import type { UpdateHierroUseCase } from '../../../application/use-cases/update-hierro.use-case.js'
import type { DeleteHierroUseCase } from '../../../application/use-cases/delete-hierro.use-case.js'

// Global use cases
import type { CrearDiagnosticoVeterinarioUseCase } from '../../../application/use-cases/crear-diagnostico-veterinario.use-case.js'
import type { GetDiagnosticoVeterinarioUseCase } from '../../../application/use-cases/get-diagnostico-veterinario.use-case.js'
import type { ListDiagnosticosVeterinariosUseCase } from '../../../application/use-cases/list-diagnosticos-veterinarios.use-case.js'
import type { UpdateDiagnosticoVeterinarioUseCase } from '../../../application/use-cases/update-diagnostico-veterinario.use-case.js'
import type { DeleteDiagnosticoVeterinarioUseCase } from '../../../application/use-cases/delete-diagnostico-veterinario.use-case.js'
import type { CrearMotivoVentaUseCase } from '../../../application/use-cases/crear-motivo-venta.use-case.js'
import type { GetMotivoVentaUseCase } from '../../../application/use-cases/get-motivo-venta.use-case.js'
import type { ListMotivosVentasUseCase } from '../../../application/use-cases/list-motivos-ventas.use-case.js'
import type { UpdateMotivoVentaUseCase } from '../../../application/use-cases/update-motivo-venta.use-case.js'
import type { DeleteMotivoVentaUseCase } from '../../../application/use-cases/delete-motivo-venta.use-case.js'
import type { CrearCausaMuerteUseCase } from '../../../application/use-cases/crear-causa-muerte.use-case.js'
import type { GetCausaMuerteUseCase } from '../../../application/use-cases/get-causa-muerte.use-case.js'
import type { ListCausasMuerteUseCase } from '../../../application/use-cases/list-causas-muerte.use-case.js'
import type { UpdateCausaMuerteUseCase } from '../../../application/use-cases/update-causa-muerte.use-case.js'
import type { DeleteCausaMuerteUseCase } from '../../../application/use-cases/delete-causa-muerte.use-case.js'
import type { CrearLugarCompraUseCase } from '../../../application/use-cases/crear-lugar-compra.use-case.js'
import type { GetLugarCompraUseCase } from '../../../application/use-cases/get-lugar-compra.use-case.js'
import type { ListLugaresComprasUseCase } from '../../../application/use-cases/list-lugares-compras.use-case.js'
import type { UpdateLugarCompraUseCase } from '../../../application/use-cases/update-lugar-compra.use-case.js'
import type { DeleteLugarCompraUseCase } from '../../../application/use-cases/delete-lugar-compra.use-case.js'
import type { CrearLugarVentaUseCase } from '../../../application/use-cases/crear-lugar-venta.use-case.js'
import type { GetLugarVentaUseCase } from '../../../application/use-cases/get-lugar-venta.use-case.js'
import type { ListLugaresVentasUseCase } from '../../../application/use-cases/list-lugares-ventas.use-case.js'
import type { UpdateLugarVentaUseCase } from '../../../application/use-cases/update-lugar-venta.use-case.js'
import type { DeleteLugarVentaUseCase } from '../../../application/use-cases/delete-lugar-venta.use-case.js'

import type { CreateCausaMuerteDto, CreateDiagnosticoVeterinarioDto, CreateHierroDto, CreateLugarCompraDto, CreateLugarVentaDto, CreateMotivoVentaDto, CreatePropietarioDto, CreateVeterinarioDto, UpdateCausaMuerteDto, UpdateDiagnosticoVeterinarioDto, UpdateHierroDto, UpdateLugarCompraDto, UpdateLugarVentaDto, UpdateMotivoVentaDto, UpdatePropietarioDto, UpdateVeterinarioDto } from '../../../application/dtos/maestros.dto.js'
