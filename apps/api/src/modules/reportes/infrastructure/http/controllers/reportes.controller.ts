...
import type { GetInventarioReportUseCase } from '../../../application/use-cases/get-inventario-report.use-case.js'
import type { GetReproductivoReportUseCase } from '../../../application/use-cases/get-reproductivo-report.use-case.js'
import type { GetMortalidadReportUseCase } from '../../../application/use-cases/get-mortalidad-report.use-case.js'
import type { GetMovimientoReportUseCase } from '../../../application/use-cases/get-movimiento-report.use-case.js'
import type { GetSanitarioReportUseCase } from '../../../application/use-cases/get-sanitario-report.use-case.js'
import type { CountReportDataUseCase } from '../../../application/use-cases/count-report-data.use-case.js'
import type { GenerateSyncExportUseCase } from '../../../application/use-cases/generate-sync-export.use-case.js'
import type { EnqueueExportJobUseCase } from '../../../application/use-cases/enqueue-export-job.use-case.js'
import type { GetExportStatusUseCase } from '../../../application/use-cases/get-export-status.use-case.js'
import type { ListExportJobsUseCase } from '../../../application/use-cases/list-export-jobs.use-case.js'
import type { DeleteExportJobUseCase } from '../../../application/use-cases/delete-export-job.use-case.js'
import type { DownloadExportFileUseCase } from '../../../application/use-cases/download-export-file.use-case.js'
import type { ExportRequestDto, ReporteFiltrosDto } from '../../../application/dtos/reportes.dto.js'
