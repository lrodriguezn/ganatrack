...
import { serviciosVeterinariosAnimales, serviciosVeterinariosProductos, animales } from '@ganatrack/database/schema'
import type { SanitarioReportDto, ReporteFiltrosDto } from '../dtos/reportes.dto.js'
